...
<section class="sk-page-header">
    <div class="container">
        ...
        <p>Practice {{ $subject['name'] }} MCQs specifically curated for {{ $testType['name'] }} preparation.</p>
        <div class="d-flex gap-2 flex-wrap mt-3">
            ...
            @endif
            <a href="#available-topics" class="btn btn-sk-outline-light btn-lg"><i class="bi bi-journal-text me-2"></i>Browse Topics</a>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row g-4">
            <div class="col-lg-8">
                ...
                <div class="sk-card bg-soft mb-4">
                    <h4 class="mb-1">{{ $mcqCount }} MCQs Available</h4>
                    <p class="text-secondary-custom mb-0">Across {{ count($topics) }} topics in {{ $subject['name'] }}</p>
                </div>

                <h3 id="available-topics" class="mb-3">Available Topics</h3>
                @if(count($topics) > 0)
                <div class="row g-3">
