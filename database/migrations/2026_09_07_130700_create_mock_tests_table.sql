CREATE TABLE IF NOT EXISTS mock_tests (
    ...
    UNIQUE KEY uq_mock_tests_slug (slug),
    KEY idx_mock_tests_test_type (test_type_id),
    KEY idx_mock_tests_featured (is_featured),
    CONSTRAINT fk_mock_tests_test_type FOREIGN KEY (test_type_id) REFERENCES test_types (id) ON DELETE CASCADE
