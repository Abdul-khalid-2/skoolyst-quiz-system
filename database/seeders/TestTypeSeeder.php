...
return function (PDO $pdo): void {
    $testTypes = [
        ...
        ['name' => 'English', 'slug' => 'english', 'icon' => 'bi-translate', 'badge_class' => 'sk-badge-info', 'description' => 'English language proficiency MCQs covering grammar, vocabulary, comprehension, and sentence correction.'],
        ['name' => 'General Knowledge', 'slug' => 'general-knowledge', 'icon' => 'bi-globe-americas', 'badge_class' => 'sk-badge-success', 'description' => 'World history, geography, current affairs, Pakistan studies, and everyday science MCQs.'],
    ];
